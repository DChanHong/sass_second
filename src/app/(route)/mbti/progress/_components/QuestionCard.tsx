...
export default function QuestionCard({ current, total, question, options, onSelect }: QuestionCardProps) {
    return (
        <section className="w-full h-full flex flex-col justify-between">
            ...
            {/* 아래 스와이프 안내 */}
            <div className="mt-auto text-center text-gray-400 text-sm pt-10">▼ 아래로 넘겨 다음 질문</div>
        </section>
    );
}
